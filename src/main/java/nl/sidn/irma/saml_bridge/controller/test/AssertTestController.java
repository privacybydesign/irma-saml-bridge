...
public class AssertTestController {
    ...
    private static final String AUTHNREQUEST_ID = "0";
    private static final String RETURN_URL = "http://test";
    private static final String ISSUER = "sidn-irma-saml-bridge";
    private static final String RELAY_STATE = "relay_state_test";
    private static final String ATTRIBUTE_KEY = "pbdf.gemeente.personalData.fullname";
    private static final String ATTRIBUTE_VALUE = "W.Geraedts";
    ...
    public void testAssert(
            final HttpServletResponse httpServletResponse) throws IOException, DecodingException {
        ...
        final HttpPost request = new HttpPost(String.format("%s/assert", BASE_URL));

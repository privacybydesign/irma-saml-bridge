 ...
 * SAML 2 HTTP-Redirect DEFLATE binding.
 */
public class SAML2HTTPRedirectDeflateSignatureSecurityHandler extends BaseSAMLSimpleSignatureSecurityHandler {
    ...
    protected byte[] getSignedContent() throws MessageHandlerException {
        // We need the raw non-URL-decoded query string param values for HTTP-Redirect
        // DEFLATE simple signature
        // validation.
    ...
    @Nonnull
    @NotEmpty
    private String buildSignedContentString(final String queryString)
